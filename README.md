...
DBTOOL是一个Android应用，用于监听系统媒体通知，并将音乐播放信息实时推送给车机系统。通过伪装成特定应用（如帆书），实现与车机的无缝集成。

### 核心功能

- 🎵 **媒体监听**：实时监听系统通知，获取当前播放的音乐信息
- 🎮 **媒体控制**：通过无障碍服务模拟媒体按键，控制音乐播放
- 🚗 **车机集成**：通过ContentProvider向车机系统提供媒体信息
- 📡 **广播通信**：支持多种车机协议（亿连、极氪等）
- 🔄 **后台运行**：使用前台服务保证长期运行
